    ...
    <header className="fixed inset-x-0 top-0 z-50 flex justify-center px-4 pt-4 sm:px-6 sm:pt-6">
      <motion.nav
        ...
        className={cn(
          ...
          scrolled
            ? "border-white/10 bg-night/60 shadow-lg shadow-night/40 backdrop-blur-xl"
      ...
      <AnimatePresence>
        {open ? (
          <motion.div
            ...
            className="fixed inset-0 -z-10 flex flex-col items-center justify-center gap-2 bg-night/85 backdrop-blur-2xl md:hidden"
          >
